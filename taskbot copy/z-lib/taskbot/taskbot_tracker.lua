...
function questLineTracker(questId, questMissions)
	...
	if StorageConfig["quests"]["Killing in the Name of..."] and questId == StorageConfig["quests"]["Killing in the Name of..."]["id"] then
...
tasksTracker = macro(2000, function()
	...
	if StorageConfig["quests"]["Killing in the Name of..."] then
		local id = StorageConfig["quests"]["Killing in the Name of..."]["id"]
		g_game.requestQuestLine(id)
	end
end)
