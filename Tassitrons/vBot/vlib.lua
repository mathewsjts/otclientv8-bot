...
Spells['Fury of Nature'] = {id = 179, words = "exevo gran gran tera", exhaustion = 40000, premium = true, type = "Instant", icon = "furyofnature", mana = 900, level = 55, soul = 0, group = {[1] =  4000, [4] = 40000}, vocations = {4}}
Spells['Rapid Smithing'] = {id = 34, words = 'revo max hur', exhaustion = 9000, premium = true,  type = 'Instant', icon = 'rapidsmithing', mana = 360, level = 250, soul = 0, group = {[3] = 6000}, vocations = {1}}
Spells['Great Berserk'] = {id = 35, words = "uber exori", exhaustion = 8000, premium = true, type = "Instant", icon = "greatberserk", mana = math.ceil(player:getMaxMana() * 0.6), level = 100, soul = 0, group = {[1] =  4000, [4] = 8000}, vocations = {1}}
-- Spells['Stunning Whirlwindthrow'] = {id = 46, words = "exeta hur", exhaustion = 10000, premium = true, type = "Instant", icon = "stunningwhirlwindthrow", mana = 240, level = 55, soul = 0, group = {[1] =  2000}, vocations = {1}}
Spells['Intense Inflict Wound'] = {id = 202, words = "utori gran kor", exhaustion = 30000, premium = true, type = "Instant", icon = "intenseinflictwound", mana = 300, level = 400, soul = 0, group = {[1] =  2000, [6] = 30000}, vocations = {1}}
Spells['Great Whirlwindthrow'] = {id = 36, words = "exori gran hur", exhaustion = 6000, premium = true, type = "Instant", icon = "greatwhirlwindthrow", mana = 105, level = 75, soul = 0, group = {[1] =  2000, [2] = 6000}, vocations = {1}}
...
function canCast2(spell, ignoreRL, ignoreCd)
    if type(spell) ~= "string" then return end
    spell = spell:lower()
    if not getSpellData(spell) then
        if SpellCastTable[spell] then
